...
const Login = () => {
  return (
    <section className="flex-1 w-full flex flex-col items-center bg-white pt-10 pb-32">
      ...
      <h1 className=" block md:hidden lg:hidden text-4xl font-bold my-2 text-center flex-wrap  bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent ">
        Authentication
      </h1>
